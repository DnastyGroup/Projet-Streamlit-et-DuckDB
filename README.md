...
Téléverser un fichier CSV contenant des données de ventes.

Stocker et interroger ces données avec DuckDB.

Visualiser quatre indicateurs clés de performance (KPI) différents, chacun représenté par une visualisation distincte.

Filtrer dynamiquement les résultats par date, région ou produit.
...
Visualisations des Indicateurs
